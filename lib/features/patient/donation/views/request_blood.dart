  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DonationCubit, DonationState>(
      listener: (context, state) {
        if (state is RequestBloodSuccessState) {
          showDialog(
            context: context,
            builder: (context) {
              return SuccessAlert();
        ...
        else if (state is RequestBloodErrorState) {
          ScaffoldMessenger.of(context).showSnackBar(
            
            SnackBar(
              
              content: Text(state.message,style: TextStyle(fontSize: 18.sp,fontWeight: FontWeight.bold),),
            ...
            children: [
                      ...
                      children: [
                        Expanded(
                          child: Defaulttextformfield(
                            controller: cubit.locationControllerOfBlood,
              ...
              Padding(
                ...
                child: DefaultButton(
                  ...
                  child: state is RequestBloodLoadingState
                      ? SizedBox(
                          height: 20.h,
                          width: 20.w,
