  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DonationCubit, DonationState>(
      listener: (context, state) {
        if (state is RequestMachineSuccessState) {
          showDialog(
            context: context,
            builder: (context) {
              return SuccessAlert();
        ...
        } else if (state is RequestMachineErrorState) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(state.message,style: TextStyle(fontSize: 18.sp),), backgroundColor: Colors.red),
          );
        }
      },
          ...
          body: Column(
            children: [
                      ...
                      children: [
                        Expanded(
                          child: Defaulttextformfield(
                            controller: cubit.locationControllerOfMachine,
              ...
              Padding(
                ...
                child: DefaultButton(
                  onPressed: () {
                    cubit.requestMachine();
                  },

                  child: state is RequestMachineLoadingState
                      ? SizedBox(
                          height: 20.h,
                          width: 20.w,
